...
public class CompareNotEqualHandler extends Handler {
    @Override
    public void execute(JastraVirtualMachine vm, Frame frame) {
        ...
        boolean value = switch (type) {
            ...
            case BOOLEAN -> (boolean) left.raw() != (boolean) right.raw();
            case STRING -> !(left.toStringValue().equals(right.toStringValue()));
